...
Aubio().then((function(e) {
    var o, i, a, r, d = e.Pitch;
    if (function() {
        ...
        void 0 === navigator.mediaDevices.getUserMedia && (navigator.mediaDevices.getUserMedia = function(e) {
            ...
            return t || alert("getUserMedia is not implemented in this browser"),
    ...
    !("WebAssembly"in window && "AudioContext"in window && "createAnalyser"in AudioContext.prototype && "createScriptProcessor"in AudioContext.prototype && "trunc"in Math))
        return alert("Browser not supported");
    var c, s, l, u, v = null === (o = document.getElementById("pitch-wheel")) || void 0 === o ? void 0 : o.querySelector("svg"), y = null === (i = document.getElementById("pitch-freq")) || void 0 === i ? void 0 : i.querySelector(".freq"), m = null === (a = document.getElementById("pitch-freq")) || void 0 === a ? void 0 : a.querySelector(".note"), p = null === (r = document.getElementById("pitch-freq")) || void 0 === r ? void 0 : r.querySelector(".octave"), f = document.getElementById("audio-start"), g = document.getElementById("audio-pause"), h = document.getElementById("pitch-freq-text"), w = document.querySelector(".audio-block-2"), ts=document.querySelectorAll("tspan");
    v && y && m && p && f && g && h && (g.addEventListener("click", (function() {
		for(let i=0; i< ts.length; i++) {
			ts[i].style.display = 'block';
		}
		
        l.disconnect(c.destination),
        s.disconnect(l),
        c.close(),
    ...
    f.addEventListener("click", (function() {
        ...
        c = new AudioContext,
        s = c.createAnalyser(),
        l = c.createScriptProcessor(4096, 1, 1),
        u = new d("default",4096,1,c.sampleRate),
        navigator.mediaDevices.getUserMedia({
            audio: !0
        }).then((function(e) {
			console.log("here-2"),
            c.createMediaStreamSource(e).connect(s),
            s.connect(l),
            ...
            t(g, "shrink-animation");
            var o = 0;
            l.addEventListener("audioprocess", (function(e) {
                var t = n(u.do(e.inputBuffer.getChannelData(0)))
                  , i = 15 * t.index + t.cents / 100 * 15;
                if (t.name) {
                    var a = Math.trunc(Math.abs(o - i));
                    o = i;
                    var r = 15 * (a + 25);
                    y.innerText = t.frequency.toFixed(1),
                    m.innerText = t.name,
                    p.innerText = t.octave.toString(),
                    v.style.transition = "transform " + r + "ms ease",
